...
df= pd.DataFrame([
    ...
    {"Name":"Josh Vasquez", "Email":"jvasqeuz01@wm.edu", "Home":"Virginia"},
...
intro_blurb = dbc.Container(
    dbc.Card(
        dbc.CardBody([
            html.H4("Welcome to VRJC Realty", className="card-title intro-text"),
            html.P(
                "As a part of the MSBA class you will soon be applying for positions at high-end firms "
                "throughout the country, or possibly the globe. To help you get an idea of the current "
                "housing market, we have provided median home prices for all 50 states in the USA, as "
                "well as an interactive page with median prices for major countries across the globe.",
                
            )
        ]),
        className="intro-card-color"  # Apply your card color class here
    ),
    className="my-4"
)
...
def display_team_info(selected_name):
    ...
    ], style={"width": "22rem", "marginTop": "1em", 'margin-bottom' :'0'},
